...
- Accidentally removed the support for "flipped" tokens, readded it since it was causing errors
...
- Non-dynamic tokens will only have their scale used as part of calculating the token's radius when it is linked to the actor size
- Math
